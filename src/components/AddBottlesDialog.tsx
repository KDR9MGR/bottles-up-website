...
const AddBottlesDialog = ({ bookingId, open, onOpenChange, onAdded }: AddBottlesDialogProps) => {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[85vh] overflow-y-auto border-gray-800 bg-gray-950">
        <DialogHeader>
          <DialogTitle className="text-white">Add Bottles</DialogTitle>
        </DialogHeader>
        ...
        {loading ? (
          ...
          <div className="space-y-4">
            ...
            {venuePaymentMode === 'both' && cartLines.length > 0 && (
