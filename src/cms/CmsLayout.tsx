...
import { LayoutDashboard, CalendarDays, Ticket, Users, Settings, LogOut, ScanLine, CheckCircle2, ScrollText, Building2, Wine, HelpCircle, Crown, Tag } from 'lucide-react';
import {
  Sidebar,
  SidebarContent,
  SidebarGroup,
...
const navItems = [
  ...
  { to: '/cms/help', label: 'Help & Guides', icon: HelpCircle },
];
